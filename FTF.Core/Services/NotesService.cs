    ...
    public class NotesService : INotesService
    {
        ...
        public void Update(int id, string text)
        {
            ...
            if (text != null)
            {
                ...
                var result = DiffTaggins(noteToUpdate, text);
        ...
        private DiffResult DiffTaggins(Note note, string text)
        {
            var tagNamesInText = text.ParseTagNames();
            ...
            return new DiffResult(taggingsToAdd, taggingsToDelete);
        }
        ...
        private class DiffResult
        {
            ...
            public DiffResult(IEnumerable<Tagging> added, IEnumerable<Tagging> deleted)
            {
                Added = added;
                Deleted = deleted;
            }
